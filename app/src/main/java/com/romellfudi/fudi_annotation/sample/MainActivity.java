...
//        objectItems.add(new ObjectItem("onLongClick 2"));
        lv_items.setAdapter(new AdaptarItem(this, R.layout.row_item, objectItems));

    }

    @OnClick(identifier = R.id.btn_apretar)
    private void info() {
        Toast.makeText(this, "Puedo!", Toast.LENGTH_SHORT).show();
    }

    @OnLongClick(identifier = R.id.btn_apretar)
    private void infoMaximo() {
        Toast.makeText(this, "Puedo Muchísimo!", Toast.LENGTH_SHORT).show();
    }
